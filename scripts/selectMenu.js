...
function show_mySelectMenu(e, curField, menu) {
	if (isIE) {
		menu.style.left = (e.clientX + document.documentElement.scrollLeft) + 20 + "px";
		menu.style.top = (e.clientY + document.documentElement.scrollTop) + 20 + "px";
	} else {
