...
//        /** full template condensed, must be comma separated */
        {
            calledRequest: "LoxRentalPROS.GetPrice",
            actions: [
                {
                    condition: "return>Response>EvaluationResult>Element[name='q_Target_Tier1']",
//                    fromPage: "<page ID>",
//                    goToPage: "<page ID>",
                    options: {
                    },
                    ...
                    afterRendering: function ($doc, c8oData) {
                    	$(document).on("click", "#accept_pricing", function(){
                    		parent.opener.doTransaction('pricing','');
                    	});
                    }
...
C8O.addHook("init_finished", function (params) {
	C8O.call(params.__project+"."+params.__sequence, params);
